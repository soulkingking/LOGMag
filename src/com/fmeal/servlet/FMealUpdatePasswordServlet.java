...
/**
 * Servlet implementation class FMealUpdatePasswordServlet
 */
@WebServlet("/FMealUpdatePasswordServlet")
public class FMealUpdatePasswordServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		UserInfo user=userDao.updatePassword(userInfo);
