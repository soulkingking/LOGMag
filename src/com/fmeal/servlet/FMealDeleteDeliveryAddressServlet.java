...
/**
 * Servlet implementation class FMealDeleteDeliveryAddressServlet
 */
@WebServlet("/FMealDeleteDeliveryAddressServlet")
public class FMealDeleteDeliveryAddressServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<DeliveryAddress> deliveryAddresses=fMealDeliveryAddressDao.deleteUserAddress(da_id, u_id);
