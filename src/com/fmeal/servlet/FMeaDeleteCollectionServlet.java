...
/**
 * Servlet implementation class FMeaDeleteCollectionServlet
 */
@WebServlet("/FMeaDeleteCollectionServlet")
public class FMeaDeleteCollectionServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SellerCollection sellerCollection=fMealCollectionDao.deleteCollection(s_id, u_id);
