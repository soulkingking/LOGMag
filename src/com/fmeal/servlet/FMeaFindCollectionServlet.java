...
/**
 * Servlet implementation class FMeaFindCollectionServlet
 */
@WebServlet("/FMeaFindCollectionServlet")
public class FMeaFindCollectionServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SellerCollection sellerCollection=fMealCollectionDao.findCollection(s_id, u_id);
