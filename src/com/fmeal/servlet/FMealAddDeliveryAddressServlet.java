...
/**
 * Servlet implementation class FMealAddDeliveryAddressServlet
 */
@WebServlet("/FMealAddDeliveryAddressServlet")
public class FMealAddDeliveryAddressServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<DeliveryAddress> deliveryAddresses=fMealDeliveryAddressDao.addDeliveryAddress(deliveryAddress);
