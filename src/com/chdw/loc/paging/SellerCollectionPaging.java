 ...
 */
@WebServlet("/SellerCollectionPaging.view")
public class SellerCollectionPaging extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SellerCollectionPaging() {
        super();
    }
	...
	private void processRequest(HttpServletRequest request,
		...
		PagingBean<SellerCollection> pagingBean = sellerCollectionDaoImpl.getPageBean(9, currPage, where);
		
		request.setAttribute("sellerCollectionPagingBean", pagingBean);
		request.getRequestDispatcher("/sellerCollection_mag.jsp").forward(request,response);
	}
