 ...
 */
@WebServlet("/FoodRingMembersPaging.view")
public class FoodRingMembersPaging extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FoodRingMembersPaging() {
        super();
    }
	...
	private void processRequest(HttpServletRequest request,
		...
		FoodRingMembersDaoImpl foodRingMembersDaoImpl = new FoodRingMembersDaoImpl();
		PagingBean<FoodRingMembers> pagingBean=foodRingMembersDaoImpl.getPageBean(6, currPage, where);
		
		request.setAttribute("foodRingMembersPagingBean", pagingBean);
