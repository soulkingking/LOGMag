 ...
 */
@WebServlet("/RestMenuTypePaging.view")
public class RestMenuTypePaging extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RestMenuTypePaging() {
        super();
    }
	...
	private void processRequest(HttpServletRequest request,
		...
		PagingBean<RestMenuType> pagingBean = restMenuTypeDaoImpl.getPageBean(9, currPage, where);
		
		request.setAttribute("restMenuTypePagingBean", pagingBean);
		request.getRequestDispatcher("/restMenuType_mag.jsp").forward(request,response);
	}
