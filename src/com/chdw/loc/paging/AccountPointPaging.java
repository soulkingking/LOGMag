...
/**
 * Servlet implementation class StudentContorl
 */
@WebServlet("/AccountPointPaging.view")
public class AccountPointPaging extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AccountPointPaging() {
        super();
    }
	...
	private void processRquest(HttpServletRequest request,
		...
		PagingBean<AccountPoint> pagingBean=accountPointDaoImpl.getPageBean(6, currPage, where);
		
		request.setAttribute("accountPointPagingBean", pagingBean);
		request.getRequestDispatcher("/accountPoint_mag.jsp").forward(request,response);
		return ;
