 ...
 */
@WebServlet("/RestCollectionPaging.view")
public class RestCollectionPaging extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RestCollectionPaging() {
        super();
    }
	...
	private void processRequest(HttpServletRequest request,
		...
		PagingBean<RestCollection> pagingBean = restCollectionDaoImpl.getPageBean(9, currPage, where);
		
		request.setAttribute("restCollectionPagingBean", pagingBean);
		request.getRequestDispatcher("/restCollection_mag.jsp").forward(request,response);
	}
