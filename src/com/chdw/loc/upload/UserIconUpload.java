...
public class UserIconUpload extends HttpServlet {
	...
	private void processRequest(HttpServletRequest request,
		...
		UserInfo ui = userInfoDaoImpl.findAll("where u_id='"+ userId +"'").get(0);
		ui.setUser_icon("/upload/UserIcon/" + picName + ext);
