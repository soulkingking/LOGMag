...
<%
	if(queryCondition == null || queryCondition.equals("")) {
		...
		Restaurant rest = new RestaurantDaoImpl().findAll(queryCondition).get(0);
%>
<div class="place">
    <span>位置：</span>
    <ul class="placeul">
    ...
    <form action="<%=path %>/RestIconUpload" method="post" enctype="multipart/form-data">
    	<input type="hidden" value="<%=rest.getR_id() %>" name="userId">
	    <ul class="imglist">
		    <li class="selected">
