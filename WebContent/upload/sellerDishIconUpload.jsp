...
<%
	if(queryCondition == null || queryCondition.equals("")) {
		...
		SellerDish sd = new SellerDishDaoImpl().findAll(queryCondition).get(0);
%>
<div class="place">
    <span>位置：</span>
    <ul class="placeul">
    ...
    <form action="<%=path %>/SellerDishIconUpload" method="post" enctype="multipart/form-data">
    	<input type="hidden" value="<%=sd.getSd_id() %>" name="sdId">
	    <ul class="imglist">
		    <li class="selected">
		    		<img src="<%=path %><%=sd.getSd_icon() %>" />
		    		<br>
